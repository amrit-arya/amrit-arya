...
# ===========================================================================
HOST = "amrit"   # shown as  amrit@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Learning DevOps"),
    ("kv", "Building", "Real world projects"),
    ("kv", "Mindset", "Obsessed with tech"),
    ("kv", "Fuel", "Caffeine + snacks"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "DevOps", "Docker, CI/CD, Linux"),
    ("kv", "Cloud", "AWS, Git, GitHub Actions"),
    ("kv", "Scripting", "Python, Bash"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Shipping real world projects, not just tutorials"),
    ("bul", "Always tinkering with a new tool or stack"),
]
